...
-(id)initWithFrame:(CGRect)frame normalImage:(UIImage*)passiveImage andPressedImage:(UIImage*)activeImage withScrollview:(UIScrollView*)scrView
{
    ...
    if (self)
    {
        ...
        _buttonView.backgroundColor = [UIColor colorWithRed:197.0/255.0 green:17.0/255.0 blue:98.0/255.0 alpha:1.0];
        _buttonView.userInteractionEnabled = YES;
        _buttonView.layer.cornerRadius=CGRectGetWidth(_buttonView.frame)/2;
...
-(void) setupButton
{
    ...
    _bgView.backgroundColor = [UIColor colorWithWhite:0.9f alpha:0.8];
    _bgView.alpha = 0;
    ...
    CGRect imageViewFrame = CGRectMake(CGRectGetMinX(self.bounds),CGRectGetMinY(self.bounds), CGRectGetWidth(self.bounds)/2, CGRectGetHeight(self.bounds)/2);
    _normalImageView = [[UIImageView alloc]initWithFrame:imageViewFrame];
    [_normalImageView setCenter:CGPointMake(CGRectGetWidth(self.bounds)/2, CGRectGetHeight(self.bounds)/2)];
    
    _normalImageView.userInteractionEnabled = YES;
    _normalImageView.contentMode = UIViewContentModeScaleAspectFit;
    //_normalImageView.center=self.center;

    
    _pressedImageView  = [[UIImageView alloc]initWithFrame:imageViewFrame];
     [_pressedImageView setCenter:CGPointMake(CGRectGetWidth(self.bounds)/2, CGRectGetHeight(self.bounds)/2)];
    //_pressedImageView.backgroundColor = [UIColor redColor];
